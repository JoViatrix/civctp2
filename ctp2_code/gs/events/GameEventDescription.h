...
//   be executed after all the other events. (14-Nov-2007 Martin G�hmann)
// - Separated the Settle event drom the Settle in City event. (19-Feb-2008 Martin G�hmann)
// - Seperated the CheckOrders event from MoveUnits event. (13-Aug-2008 Martin G�hmann)
...
// - Added upgrade events. (13-Sep-2008 Martin G�hmann)
//
//----------------------------------------------------------------------------
