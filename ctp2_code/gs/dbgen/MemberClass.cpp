...
//
// - Members of substructs can now have default values, added by Martin G�hmann.
...
// - Added alias names. (Aug 26th 2005 Martin G�hmann)
// - Costum structs can now include other custom structs, given both are
//   direct members of the record class (Support for DiffDB). (Sep 15th 2005 Martin G�hmann)
// - Parser for struct ADVANCE_CHANCES of DiffDB.txt can now be generated. (Jan 3rd 2006 Martin G�hmann)
// - Fixed subsubstruct generation so that it can be used in DiffDB.txt. (April 29th 2006 Martin G�hmann)
                           ...
                           char *subType)
{
	...
	//Added by Martin G�hmann to allow struct members to have default values
